...
public class Handlers {
    ...
    Matchers matchers
    iso19139bfs.Functions isofunc
    common.Handlers commonHandlers
    List<String> packageViews
    String rootEl = 'bfs:MD_Metadata'
    ...
    public Handlers(handlers, f, env) {
        ...
        isofunc = new iso19139bfs.Functions(handlers: handlers, f:f, env:env, commonHandlers: commonHandlers)
