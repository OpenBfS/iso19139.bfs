...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  -->
  <xsl:template mode="mode-iso19139.bfs" priority="100" match="gmd:topicCategory">
  ...
  -->
  <xsl:template mode="mode-iso19139.bfs" match="gts:TM_PeriodDuration|gml:duration" priority="200">
  ...
  <xsl:template mode="mode-iso19139.bfs" match="gml:beginPosition|gml:endPosition|gml:timePosition"
    priority="200">
  ...
  <xsl:template mode="mode-iso19139.bfs" match="gmd:EX_GeographicBoundingBox" priority="2000">
