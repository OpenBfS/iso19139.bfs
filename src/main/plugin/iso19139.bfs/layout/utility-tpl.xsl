...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19139.bfs-online-source-config">
  ...
  <xsl:template name="get-iso19139.bfs-is-service">
    <xsl:call-template name="get-iso19139-is-service">
    </xsl:call-template>
  </xsl:template>

  <xsl:template name="get-iso19139.bfs-title">
    <xsl:call-template name="get-iso19139-title">
    </xsl:call-template>
  </xsl:template>

  <xsl:template name="get-iso19139.bfs-extents-as-json">
